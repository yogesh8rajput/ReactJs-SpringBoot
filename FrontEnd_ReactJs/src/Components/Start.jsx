...
import heroImage from '../Components/mikku.jpg'; // Add your hero image here
import serviceImage1 from '../Components/mikku.jpg'; // Add service images
import serviceImage2 from '../Components/mikku.jpg';
    ...
    <div className="font-sans bg-gray-200 text-gray-900 ">
      ...
      <nav className="bg-slate-900 text-white p-4 shadow-lg ">
        <div className="max-w-screen-xl mx-auto flex justify-between items-center">
          <div><img src={clientbridge} alt="CRM Hero" className="w-1/2" /></div>
      ...
      {/* Hero Section */}
      <section className="bg-slate-900 text-white py-20 h-screen" id="home">
        <div className="max-w-screen-xl mx-auto flex items-center justify-between px-6">
          ...
          <div>
            <img src={heroImage} alt="CRM Hero" className="w-full max-w-md rounded-lg shadow-lg" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20" id="services">
        ...
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6">
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 text-center hover:scale-105 transform transition duration-300 hover:bg-gray-100">
            <img src={serviceImage1} alt="Service 1" className="w-24 h-24 mx-auto mb-4" />
          ...
          {/* Service 2 */}
          <div className="bg-white shadow-lg rounded-lg p-6 text-center hover:scale-105 transform transition duration-300 hover:bg-gray-100">
            <img src={serviceImage2} alt="Service 2" className="w-24 h-24 mx-auto mb-4" />
          ...
          {/* Service 3 */}
          <div className="bg-white shadow-lg rounded-lg p-6 text-center hover:scale-105 transform transition duration-300 hover:bg-gray-100">
            <img src={serviceImage1} alt="Service 3" className="w-24 h-24 mx-auto mb-4" />
            <h3 className="text-xl font-semibold mb-2">Software Management</h3>
            <p className="text-gray-500">We help you manage and maintain your CRM software, ensuring optimal performance and security.</p>
          </div>
        </div>
      </section>
